...
ServerEvents.tags('item', event => {
    ...
    event.add('forge:cookingoil', 'gourmet:seed_oil_bottle')
    event.add('forge:crops/spiceleaf', 'farmersrespite:green_tea_leaves')
    event.add('forge:crops/tealeaf', 'farmersrespite:green_tea_leaves')
    event.add('forge:spices/groundcinnamon', 'festive_delight:cinnamon_powder')
    event.add('forge:spices/groundcinnamon', 'croptopia:cinnamon')
    event.add('forge:fries', 'gourmet:cooked_fries', 'croptopia:french_fries')
    event.add('forge:chocolates', 'neapolitan:chocolate_bar', 'create:bar_of_chocolate')
    event.add('forge:chocolatebar', 'create:bar_of_chocolate', 'neapolitan:chocolate_bar')
    ...
    event.add('forge:crops/cinnamon', 'festive_delight:cinnamon_sticks')
    event.add('forge:crops/avocado', 'culturaldelights:avocado')
    event.add('forge:fruits/avocado', 'culturaldelights:avocado')
    ...
    event.add('forge:calamari', 'culturaldelights:raw_calamari')
    event.add('forge:cooked_calamari', 'culturaldelights:cooked_calamari')
    event.add('forge:noodles', 'farmersdelight:raw_pasta')
    event.add('forge:tortillas', 'culturaldelights:tortilla')
    event.add('forge:blts', 'farmersdelight:bacon_sandwich')
    event.add('forge:milk/milk_bottle', ['neapolitan:milk_bottle', 'productivebees:milk_bottle', 'hexerei:milk_bottle', 'croptopia:milk_bottle'])
    ...
    event.add('forge:cheeses', 'gourmet:cheese', 'croptopia:cheese', 'brewinandchewin:flaxen_cheese_wedge')
    event.add('forge:ice_cubes', 'gourmet:ice_cube')
    event.add('forge:raw_bacon', 'gourmet:raw_bacon', 'croptopia:bacon')
