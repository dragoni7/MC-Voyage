...
ServerEvents.tags('item', event => {
    ...
    event.add('forge:fries', 'gourmet:cooked_fries', 'pamhc2foodcore:friesitem')
    ...
    event.remove('forge:cheese', 'pamhc2foodextended:silkentofuitem')
    event.remove('forge:butter', 'pamhc2foodextended:silkentofuitem')
    event.remove('forge:crops/tealeaf', 'pamhc2crops:tealeafitem')
})