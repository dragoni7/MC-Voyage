...
ServerEvents.recipes(event => {
	let recipes = [
		...
		'pamhc2foodcore:flour_x1_flour_plants',
		'pamhc2foodextended:tortillaitem',
		'pamhc2foodcore:cookingoilitem_x2_vegetables',
